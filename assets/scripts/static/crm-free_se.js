...
const textInvalidField = 'Fält ogiltig';
const textInvalidMail = 'E-post ogiltig';
const textValidDomain = 'Domänen är bekräftad';
const textFailedDomain = 'Kunde inte bekräfta domänen';
...
const textReadyApp = 'Ditt LiveAgent är redo';
const textDoneAppTitle = 'Ditt LiveAgent är redo';
