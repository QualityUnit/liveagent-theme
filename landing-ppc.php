...
<div class="LandingPPC <?php echo esc_attr( $internal_linking_class ); ?>">
					...
					<section
						...
						<div class="elementor-container elementor-column-gap-default">
									...
									<div
										...
										<div class="elementor-widget-container">
											<h1 class="elementor-heading-title elementor-size-default"
													id="h-provide-excellent-customer-service">
												<?=
									...
									<div
										...
										<div class="elementor-widget-container">
											...
											<div class="heroBanner__content__footer__cta">
												<a
													href="<?= get_post_meta( get_the_ID(), 'header_button_url', true ); // @codingStandardsIgnoreLine  ?>"
							...
							<div
								...
								<div class="elementor-widget-wrap elementor-element-populated">
									<div
										class="elementor-element elementor-element-1d37a861 homeVideo elementor-widget elementor-widget-image"
										<?php
  ...
  <section class="elementor-section">
	...
	<section class="LandingPPC-floatingBlock">
		<div class="LandingPPC-cols  LandingPPC-cols-3">
			<div class="LandingPPC-col">
				<img class="LandingPPC-col__icon mb-l"
						 src="<?= esc_url( get_template_directory_uri() . '/assets/images/landingppc_plus_icon.svg' ); ?>"
						 alt="icon"/>
				<h4>
					<?=
	...
	<section class="mb-extreme-plus">
		<div class="wrapper LandingPPC-Connect">
			<picture class="urlslab-skip-all">
				<source
					srcset="<?= esc_url( get_template_directory_uri() . '/assets/images/landing_ppc_all-channels_mobile.jpg' ); ?>"
					media="(max-width: 1023px)">
				<img src="<?= esc_url( get_template_directory_uri() . '/assets/images/landing_ppc_all-channels.jpg' ); ?>"
	...
	<section class="bg-level4 pt-extreme-small pb-extreme-small">
		<div class="wrapper">
			<div class="LandingPPC-HeaderSection mb-l mt-0">
