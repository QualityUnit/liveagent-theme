...
<div id="blackfridaybanner" class="BlackFridayBanner hidden">
	<a href="/black-friday/" class="BlackFridayBanner__link">
			<span class="BlackFridayBanner__close" id="blackfridaybanner-close">
				<img src="<?= esc_url( get_template_directory_uri() . '/assets/images/close.png' ); ?>" alt="<?= __( 'Close', 'ms' ); ?>" />
			</span>
		<div class="BlackFridayBanner__wrapper wrapper">
				<div class="BlackFridayBanner__text">
				<span class="BlackFridayBanner__pretitle"><?= __( '12.Nov-11.Dec 2025', 'ms' ); ?></span>
				<h2 class="BlackFridayBanner__title text-stroke-primary"><?= __( 'BLACK FRIDAY', 'ms' ); ?></h2>
				<h3 class="BlackFridayBanner__subtitle"><?= __( '75% OFF', 'ms' ); ?></h3>
				<p class="BlackFridayBanner__desc"><?= __( 'For all new accounts for the first 6 months', 'ms' ); ?></p>
			</div>
			<div class="BlackFridayBanner__image">
				<img src="<?= esc_url( get_template_directory_uri() . '/assets/images/' . $random_image ); ?>" alt="<?= __( 'Black Friday Offer', 'ms' ); ?>" />
			</div>
		</div>
	</a>
</div>
