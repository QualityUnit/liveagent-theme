...
<div class="FullScreen">
	...
	<div class="FullScreen__sidebar">
		<div class="FullScreen__sidebar__item" style="background-image: url(<?= esc_url( home_url( '/', 'relative' ) ); ?>app/uploads/2020/01/bg_trial.jpg);">
			<div class="FullScreen__sidebar__item__text">
				...
				<img src="<?= esc_url( home_url( '/', 'relative' ) ); ?>app/uploads/2019/11/logo_slido_white.svg" alt="<?php _e( 'Review', 'ms' ); ?>">
			</div>
		</div>
	</div>
