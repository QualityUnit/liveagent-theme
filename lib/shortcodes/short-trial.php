...
function ms_short_trial() {
	...
	$stars_item_icon = get_template_directory_uri() . '/assets/images/icon_star_black.svg';
	?>
	...
	<div class="ShortTrial__form">
		...
		<div class="Portals__text__details">
			...
			<p><?php _e( '3,000+ reviews', 'ms' ); ?>
				<a href="<?php _e( '/awards/', 'ms' ); ?>"><img src="<?= esc_url( get_template_directory_uri() ); ?>/assets/images/logo_capterra_black.svg" alt="<?php _e( 'Capterra', 'ms' ); ?>"></a>
