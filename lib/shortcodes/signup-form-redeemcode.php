...
function ms_signup_form_redeem_code( $atts ) {
	...
	<div class="Signup__form">
		...
		<form action="<?php echo esc_url( $submit_slug ); ?>" method="post" data-form-type="signup-trial-form" data-id="signup">
			...
			<div data-id="codeFieldmain" class="Signup__form__item has-svg <?php echo esc_attr( $inputs_states['redeem_code']['class'] ); ?>">
				<div class="InputWrapper">	
					...
					<input type="text" data-type="text" name="redeem_code" placeholder="<?php _e( 'Redeem code', 'ms' ); ?>" value="<?php echo esc_attr( $inputs_states['redeem_code']['value'] ); ?>" required="required" autocomplete="off" maxlength="100">
				</div>
				<div class="ErrorMessage"><?php echo esc_html( $inputs_states['redeem_code']['error'] ); ?></div>
			</div>

			<div data-id="nameFieldmain" class="Signup__form__item has-svg <?php echo esc_attr( $inputs_states['fullname']['class'] ); ?>">
				<div class="InputWrapper">	
					...
					<input type="text" data-type="text" name="fullname" placeholder="<?php _e( 'Full name', 'ms' ); ?>" value="<?php echo esc_attr( $inputs_states['fullname']['value'] ); ?>" required="required" autocomplete="off" maxlength="100">
				</div>
				<div class="ErrorMessage"><?php echo esc_html( $inputs_states['fullname']['error'] ); ?></div>
			</div>

			<div data-id="mailFieldmain" class="Signup__form__item <?php echo esc_attr( $inputs_states['email']['class'] ); ?>">
				<div class="InputWrapper fontello-mail">
					<input type="email" name="email" placeholder="<?php _e( 'Enter your e-mail', 'ms' ); ?>" value="<?php echo esc_attr( $inputs_states['email']['value'] ); ?>" required="required" autocomplete="off" maxlength="255">
				</div>
				<div class="ErrorMessage"><?php echo esc_html( $inputs_states['email']['error'] ); ?></div>
			</div>

			<div data-id="domainFieldmain" class="Signup__form__item has-svg <?php echo esc_attr( $inputs_states['subdomain']['class'] ); ?>">
				<div class="InputWrapper">
					...
					<input type="text" data-type="text" name="subdomain" placeholder="<?php _e( 'Company name', 'ms' ); ?>" value="<?php echo esc_attr( $inputs_states['subdomain']['value'] ); ?>" required="required"  autocomplete="off" maxlength="30">
					<div class="Signup__form__item__domain"><?php _e( '.ladesk.com', 'ms' ); ?></div>
				</div>
				<div class="ErrorMessage"><?php echo esc_html( $inputs_states['subdomain']['error'] ); ?></div>
			...
			<div data-id="regionFieldmain" class="Signup__form__item has-svg <?php echo esc_attr( $inputs_states['region']['class'] ); ?>">
				<div class="InputWrapper">
					<div class="FilterMenu isSingleSelect">
						...
						<span>
							<?php
							if ( $inputs_states['region']['value'] ) {
								echo esc_html( $regions[ $inputs_states['region']['value'] ] );
							} else {
								_e( 'Choose your region (datacenter location)', 'ms' );
							}
							?>
							</span>
						</div>
								...
								<?php foreach ( $regions as $region_code => $region_name ) { ?>
									<div class="checkbox FilterMenu__item">
										<input 
											...
											<?php echo $inputs_states['region']['value'] === $region_code ? 'checked="checked"' : ''; ?> 
										/>
				...
				<div class="ErrorMessage"><?php echo esc_html( $inputs_states['region']['error'] ); ?></div>
			...
			<div data-id="signUpError" class="<?php echo $signup_error ? '' : 'hidden'; ?>"><?php echo esc_html( $signup_error ); ?></div>
