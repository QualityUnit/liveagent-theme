...
function ms_signup_form_redeem_code( $atts ) {
	...
	<div class="Signup__form">
		...
		<form action="<?php echo esc_url( $submit_slug ); ?>" method="post" data-form-type="signup-trial-form">
			...
			<div data-id="signup">
				...
				<div data-id="mailFieldmain" class="Signup__form__item fontello-mail <?php echo esc_attr( $inputs_states['email']['class'] ); ?>">
				...
				<div data-id="domainFieldmain" class="Signup__form__item has-svg <?php echo esc_attr( $inputs_states['subdomain']['class'] ); ?>">
					...
					<input type="text" name="subdomain" placeholder="<?php _e( 'Company name', 'ms' ); ?>" value="<?php echo esc_attr( $inputs_states['subdomain']['value'] ); ?>" required="required"  autocomplete="off" maxlength="30">
