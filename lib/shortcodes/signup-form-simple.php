			...
			<div class="Signup__form__step" data-step="1">
				<div class="Signup__form--simple__header">
					...
					<div class="Signup__form__step--text">
						<div class="Signup__form__step--progress">
							...
							<span class="Signup__form__step--progress-steps">1/2</span>
						</div>
						<div class="Signup__form__step--text-text">
							<?php _e( 'You are almost there!', 'ms' ); ?>
				...
				<div class="Signup__form__step--fields">
					...
					<div class="Signup__form--simple__reviews">
						<div class="Signup__form--simple__reviews--title"><?= esc_html( $atts['trusted'] ); ?></div>
						<div class="Signup__form--simple__reviews--item">
				...
				<div class="Signup__form--simple__header">
					...
					<div class="Signup__form__step--text">
						<div class="Signup__form__step--progress">
							...
							<span class="Signup__form__step--progress-steps">2/2</span>
						</div>
						<div class="Signup__form__step--text-text">
							<?php _e( 'Just two more and account is yours!', 'ms' ); ?>
