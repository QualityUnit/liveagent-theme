				...
				<li class="Alternative">
					<a class="Alternative__inn" href="<?= esc_url( get_the_permalink( $alternative_id ) ); ?>">
						...
						<div class="Alternative__content">
							<h5 class="Alternative__title"><?= esc_html( get_the_title( $alternative_id ) ); ?></h5>
							<p class="Alternative__excerpt"><?= esc_html( wp_trim_words( get_the_excerpt( $alternative_id ), 10 ) ); ?></p>
						</div>
