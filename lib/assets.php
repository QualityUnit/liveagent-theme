...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'la-fonts', 'https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&family=Patrick+Hand&family=Poppins:wght@400;700&display=swap', false, '1' );
