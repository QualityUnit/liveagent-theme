		...
		<div class="Trial__sidebar urlslab-min-width-1024">
			<div class="Trial__sidebar__inner">
				<div class="Trial__sidebar__content checklist">
					<h3 class="Trial__sidebar__title">Handle all support channels in one solution</h3>
					<ul>
						<li>Spend 85% less time on issues</li>
						<li>Save 95% more money on support</li>
						<li>Gain 56% more returning customers</li>
						<li>Get 73% higher satisfaction rates</li>
					</ul>
				</div>
			</div>
		</div>
