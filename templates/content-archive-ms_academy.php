...
set_source( 'academy', 'pages/Category' );
set_source( 'academy', 'pages/CategoryColorScheme' );
set_source( 'academy', 'filter', 'js' );
$post_type_category = 'ms_academy_categories';
			...
			<ul class="Category__content__items list">
				...
				foreach ( $posts_by_category as $category_name => $items ) {
					...
					foreach ( $items as $item ) {
						...
						$category_item_classes      = 'Category__item redesign Category__item--academy ' . $pillar_class . ' ' . esc_attr( $category_slug ) . ' ' . esc_attr( $category_en_slug );
						$category_card_item_classes = 'Category__item redesign Category__item--academy  ' . esc_attr( $category_slug ) . ' ' . esc_attr( $category_en_slug );
									...
									<div class="Category__item__header" style="background-image: url(<?= esc_url( $backgrounds_urls['background'] ); ?>);">
										<div class="Category__item__header__image">
											...
											if ( $item_icons_url ) {
												...
												?>
												<img src="<?= esc_url( get_template_directory_uri() ); ?>/assets/images/icon-custom-post_type.svg" alt="<?php esc_attr_e( 'Academy', 'ms' ); ?>">
