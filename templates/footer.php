		...
		<div class="wrapper">
			<div class="Footer__middle__row">
				<div class="Footer__middle__contacts">
					...
					<ul>
						<li class="Footer__middle__contacts__phone"><a href="tel:<?php _e( '+421 2 33 456 826', 'ms' ); ?>" title="<?php _e( 'LiveAgent\'s phone', 'ms' ); ?>"><?php _e( '+421 2 33 456 826', 'ms' ); ?></a></li>
						<li class="Footer__middle__contacts__phone"><a href="tel:<?php _e( '+1-888-257-8754', 'ms' ); ?>" title="<?php _e( 'LiveAgent\'s phone', 'ms' ); ?>"><?php _e( '+1-888-257-8754', 'ms' ); ?></a></li>
