		...
		<div class="wrapper">
			<div class="Footer__middle__row">
				...
				<div class="Footer__middle__reviews">
					...
					<a href="https://www.g2.com/products/liveagent/reviews?utm_source=review-widget" title="Read reviews of LiveAgent on G2"><img class="full-width" style="max-width: 100px" alt="Read LiveAgent reviews on G2" src="https://www.g2.com/products/liveagent/widgets/stars?color=white&amp;type=read" /></a><script>(function(a,b,c,d){window.fetch("https://www.g2.com/products/liveagent/rating_schema.json").then(e=>e.json()).then(f=>{c=a.createElement(b);c.type="application/ld+json";c.text=JSON.stringify(f);d=a.getElementsByTagName(b)[0];d.parentNode.insertBefore(c,d);});})(document,"script");</script>
				</div>
